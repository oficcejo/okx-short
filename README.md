...
本项目是一款专为 OKX ETH-USDT 永续合约 打造的高频超短线做空利器。其核心逻辑源自对市场“压制规律”的深度理解，通过严苛的信号过滤算法，在波动中精准捕捉获利机会。也是作者通过研究okx交易所大量优秀带单员的操作规律总结而来的，从观察到复现，从模仿到超越。本项目凝聚了本人对 OKX 生态的深度钻研，将顶尖交易者的博弈智慧浓缩进每一行代码。
